...
| Capacity freed (soft)                | Hours freed x loaded cost x utilization factor                                                                               | A utilization factor and a named redeployment target - an hour to state, and finance discounts it anyway                                                      | Only cash if the freed time is redeployed to additive work                                                                                                               |

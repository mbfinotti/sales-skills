...
4. Draft 3-5 candidate variants, working down the catalog's efficiency order - for B2B cold, `internal-style noun > specific pain question > executive-world anchor > competitor == company initiative > trigger event`, replies bought per research minute. Delete any angle the interview ruled out instead of ranking it last, and say which angle was deleted and why. Each variant must express a distinct angle, never a synonym swap of another. For B2C, draft a preheader with every variant - subject plus preheader is the tested unit.
